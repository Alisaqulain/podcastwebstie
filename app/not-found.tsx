...
export default function NotFound() {
  return (
    <Container className="flex min-h-[60vh] flex-col items-center justify-center py-24 text-center">
      ...
      <h1 className="mt-4 font-display text-3xl font-semibold text-brand-dark md:text-4xl">
        This page stepped out for a breath
      </h1>
      <p className="mt-4 max-w-md text-brand-dark/65">
      ...
      <Link
        href="/podcast"
        className="mt-8 text-sm font-medium text-brand-gold-deep hover:underline"
      >
        Browse the podcast
      </Link>
    </Container>
